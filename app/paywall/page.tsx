        ...
        <div className="max-w-4xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <form onSubmit={fetchConfig} className="flex gap-2 items-center">
                ...
                />
                <button type="submit" disabled={loading} className="text-gray-600 hover:text-gray-900">
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        {!config ? (
            ...
            <>
                ...
                <span className="text-indigo-600 font-mono text-sm tracking-wider uppercase">Premium Content</span>
                ...
                <div className="relative mt-12 rounded-2xl overflow-hidden border border-gray-200 bg-white shadow-sm">
                    <div className={`p-8 transition-all duration-700 ${isUnlocked ? '' : 'blur-lg opacity-30 select-none'}`}>
                    <h3 className="text-gray-900 text-2xl font-bold mb-4">Deep Dive Analysis</h3>
                    ...
                    <div className="bg-gray-100 p-6 rounded-lg my-8 font-mono text-sm border border-gray-200">
                        <span className="text-gray-600">{'// Hidden implementation details...'}</span>
                    </div>
                    </div>

                    {!isUnlocked && (
                    <div className="absolute inset-0 z-10 flex flex-col items-center justify-center bg-gradient-to-t from-gray-50 via-gray-50/90 to-gray-50/60">
                        <div className="bg-white/90 backdrop-blur-xl p-8 rounded-2xl border border-gray-200 shadow-2xl max-w-sm w-full text-center space-y-6">
